...
- (id)init
{
	...
	if (self)
	{
		NSDictionary *dictEntity = @{
			@"Food" : @[
				@{@"property" : @"relationship", @"name" : @"meals", @"inverse" : @"foods", @"entity" : @"Meal", @"type" : @"toMany"},
				@{@"property" : @"field", @"name" : @"name", @"type" : @"string"},
				@{@"property" : @"field", @"name" : @"amount", @"type" : @"float"},
			],
			@"NutritionCategory" : @[
				@{@"property" : @"relationship", @"name" : @"subcategories", @"inverse" : @"parentcategory", @"entity" : @"NutritionCategory", @"type" : @"toMany"},
				@{@"property" : @"relationship", @"name" : @"parentcategory", @"inverse" : @"subcategories", @"entity" : @"NutritionCategory", @"type" : @"toOne"},
				@{@"property" : @"relationship", @"name" : @"meals", @"inverse" : @"category", @"entity" : @"Meal", @"type" : @"toMany"},
				@{@"property" : @"field", @"name" : @"name", @"type" : @"string"},
			],
			@"Meal" : @[
				@{@"property" : @"relationship", @"name" : @"foods", @"inverse" : @"meals", @"entity" : @"Food", @"type" : @"toMany"},
				@{@"property" : @"relationship", @"name" : @"category", @"inverse" : @"meals", @"entity" : @"NutritionCategory", @"type" : @"toOne"},
				@{@"property" : @"field", @"name" : @"name", @"type" : @"string"},
			],
		};
